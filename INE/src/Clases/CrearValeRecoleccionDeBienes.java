 ...
 * @author oscar
 */
public class CrearValeRecoleccionDeBienes {
  ...
  //  private ObtenerProductos obtener_productos;
    ...
    public CrearValeRecoleccionDeBienes(){
    ...
    public void createTicket(String pdfFilename, int res,String fecha, String hora, 
        ...
        try {
            ...
            PdfPTable encabezadof = new PdfPTable(1);
            encabezadof.setWidthPercentage(100f);
            PdfPCell encabezadofCell;
            
            encabezadofCell = new PdfPCell(new Phrase("FALTANTES", subFont3));
            encabezadofCell.setHorizontalAlignment(Element.ALIGN_CENTER);
            encabezadofCell.setBackgroundColor(BaseColor.LIGHT_GRAY);
            
            encabezadof.addCell(encabezadofCell);
            
            
            PdfPTable firma = new PdfPTable(2);
            PdfPCell firmaCell,firmaCell2;
            
            firmaCell = new PdfPCell(new Phrase("_____________________________________\nUsuario Responsable de Recolección", subFont2));
            firmaCell.setBorderColor(BaseColor.WHITE);
            firmaCell.setHorizontalAlignment(Element.ALIGN_CENTER);
            
            
            firmaCell2 = new PdfPCell(new Phrase("_____________________________________\nUsuario Responsable de Entrega", subFont2));
            ...
            for (int i = 0; i < v.size(); i++) {
                ...
                String temporal[] = v.get(i).toString().split(",,");
                ...
                cell4 = new PdfPCell(new Phrase("" +(temporal[4]), subFont2));
                cell4.setHorizontalAlignment(Element.ALIGN_LEFT);
                
                //producto
                PdfPCell cell5;

                cell5 = new PdfPCell(new Phrase("" +(temporal[5]), subFont2));
            ...
            PdfPTable falta = new PdfPTable(6);
            falta.setWidthPercentage(100f);
             //float[] tableMedidas = {0.10f, 0.10f, 0.10f,0.55f};
             //table.setWidths(tableMedidas);
            for (int i = 0; i < Faltantes.size(); i++) {
                
                String temporal[] = Faltantes.get(i).toString().split(",,");
                //Cantidad numero y letra
                PdfPCell cell;
                cell = new PdfPCell(new Phrase("" + temporal[0], subFont2));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
    ...
    public void imprimir() throws IOException{
        File fileToPrint = new File("C:\\SIIEEN\\vales\\recoleccion\\"+archivo_nombre+".pdf");
