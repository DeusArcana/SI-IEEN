-- Borrado del SP
DROP PROCEDURE IF EXISTS `usp_get_countBusquedaProducto`;
...
-- ====================================================================
DELIMITER $$
CREATE PROCEDURE `usp_get_countBusquedaProducto`(IN `Inv_Filtro` INT, IN `Inv_Estatus` VARCHAR(35), IN `Inv_Busqueda` VARCHAR(255), IN `Inv_Folio` VARCHAR(255))
BEGIN
